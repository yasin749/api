Projeyi çalıştırmak için öncelikle cihazda kurulu olan PostgreSQL database bilgileri database config file ına(src/config/databaseConfig/local.conf.js) girilmeli.
